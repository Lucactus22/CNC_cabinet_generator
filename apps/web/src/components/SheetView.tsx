  ...
  return (
    <div className="viewport">
      ...
      <div className="legend">
        <span><i className="swatch" style={{ background: '#f0a04b' }} />Profile</span>
        <span><i className="swatch" style={{ background: '#6fc48a' }} />Pocket</span>
        <span><i className="swatch" style={{ background: '#ef6b6b' }} />Through cut</span>
        <span><i className="swatch" style={{ background: '#6ba8ef' }} />Drilling</span>
        <span><i className="swatch" style={{ background: '#c778dd' }} />Tile seam and pins</span>
      </div>
