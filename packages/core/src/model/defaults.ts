...
export function defaultBaseCarcass(): Carcass {
  return {
    ...
    bayWidths: [],
    bays: [
      { shelves: 'none', shelfCount: 0, shelfGaps: [], doors: 'left', drawerFrontHeights: [] },
      { shelves: 'fixed', shelfCount: 1, shelfGaps: [], doors: 'right', drawerFrontHeights: [] },
    ],
...
export function defaultUpperCarcass(): Carcass {
  return {
    ...
    bayWidths: [],
    bays: [
      { shelves: 'fixed', shelfCount: 4, shelfGaps: [], doors: 'none', drawerFrontHeights: [] },
      {
        shelves: 'adjustable',
        shelfCount: 0,
        shelfGaps: [],
